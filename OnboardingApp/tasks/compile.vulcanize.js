...
module.exports = function(gulp) {
  return function () {
    return gulp.src([
      ...
      'public/elements/views/sample-view.html',
      'public/elements/views/subCategorySample-view.html',
      'public/elements/views/facilitiesCategory-view.html',
      'public/elements/views/thingKnow-view.html',
      'public/elements/views/importantContacts-view.html',
      'public/elements/views/otherRequestCategory-view.html',
      'public/elements/views/travel-view.html',
      'public/elements/views/payroll-view.html',
